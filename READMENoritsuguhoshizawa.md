...
2026.07.08（水）raceabc .py raceabcotonashi .pyのnumZ配列の倍数をバグが出ないように改訂いたしました。ごめんなさい。いつもどうもありがとうございます。
