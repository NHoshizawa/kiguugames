kiguuotonashi シリーズフォルダ今なら公開中
準備中音源無しで、再出発したく思っております。いままでの音声データは削除願います。今後とも宜しくお願いします。ご迷惑をおかけしました。大変申し訳ありませんでした
下記の内容は現在存在いたしませんのでご了承くださいませ。Macでは、〜otonashi.pyでpython3 ファイル名.py で動きますが、モジュールのplaysoundやpygameは動かすことはできませんでした。しかしながら、インターネットでいろいろと調べてHomebrewを入れましたらできました。感謝謝意どうもありがとうございますごめんなさい。　Windows8.1(モジュールが動きます)にて開発させて頂きました感謝謝意どうもありがとうございますごめんなさい🙇🙏
参考図書　独学プログラマー（コーリー・アルソフ　清水川貴之監訳［日経BP社］）pythonでつくるゲーム開発入門講座　廣瀬　豪〔著〕［ソーテック社］野田クリスタルと遊ぶPythonプログラミングBOOK［宝島社］等やコンピューター言語の説明ネットサイト検索にてとてもわかりやすくて勉強や研究になります。
音源はフリーソフトのdominoを使用とpc既存の動画編集ソフトにて録音編集に使用いたしました。わたしや利用者様方々への利益等利害関係の発生は全くありえませんので安全に気をつけていただきたく思っております。この新作トランプゲームkiguugames企画は飽く迄も学習能力開発支援ボランティアワーク(奉仕活動の一貫)の練習してみたかっただけです。ごめんなさい感謝謝意どうもありがとうございます😤😱U^ェ^U
