...
[https://prog-8.com/docs/python-env)](https://prog-8.com/docs/python-env)imac mini python環境参照しました。pip3やpython３インストールにて必須な説明が書いてありました。imac環境では、pip3 install playsound==1.2.2 のほかにも pip3 install pyobjc をターミナルにて実行するのが必要でした。感謝謝意です。どうも有難うございます。ごめんなさい。
