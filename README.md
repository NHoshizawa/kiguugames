ゲームプログラミングには、コンピュータ言語化の前に勿論ゲームプランニング(紙とぺんでゲーム内容を造る)をした後で、必要な技術を習得しながら、オリジナルのアルゴリズムなど、発展していくのが、コンピュータゲーム開発と言えるでしょう。わたしはそうやってしております。感謝謝意。いつもどうも有難うございます。ごめんなさい🙇
U^ェ^U(´∀｀)


9月17日(木)chike. py ポイント運用による値の返しが一律2倍となりました。また別にchike. py用のファイルでお楽しみくださいませ。
