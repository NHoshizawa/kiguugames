...
音源はフリーソフトのdominoを使用とpc既存の動画編集ソフトにて録音編集に使用いたしました。わたしや利用者様方々への利益等利害関係の発生は全くありえませんので安全に気をつけていただきたく思っております。飽く迄もボランティアワーク(奉仕活動の一貫)の練習してみたかっただけです。ごめんなさい感謝謝意どうもありがとうございます😤😱U^ェ^U
